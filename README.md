...
El objetivo del programa es modelar distintas actividades que ofrece la mutual "Mutual de Mentes, Músculos y Maletas en Movimiento", y cómo se manejan los socios respecto de estas actividades.
